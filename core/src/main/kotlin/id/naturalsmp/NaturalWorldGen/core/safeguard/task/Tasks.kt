...
import id.naturalsmp.NaturalWorldGen.core.safeguard.Mode
import id.naturalsmp.NaturalWorldGen.core.safeguard.Mode.*
import id.naturalsmp.NaturalWorldGen.core.safeguard.task.Diagnostic.Logger.*
import id.naturalsmp.NaturalWorldGen.core.safeguard.task.Task.Companion.of
import id.naturalsmp.NaturalWorldGen.util.agent.Agent
import id.naturalsmp.NaturalWorldGen.util.misc.getHardware
...
private val version by task {
    val parts = NaturalGenerator.instance.description.version.split('-')
