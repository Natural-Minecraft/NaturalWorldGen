...
package id.naturalsmp.nwg.utilities.decree;
...
public interface DecreeSystem extends CommandExecutor, TabCompleter {
    KList<DecreeParameterHandler<?>> handlers = NaturalGenerator.initialize("id.naturalsmp.nwg.utilities.decree.handlers", null).convert((i) -> (DecreeParameterHandler<?>) i);
