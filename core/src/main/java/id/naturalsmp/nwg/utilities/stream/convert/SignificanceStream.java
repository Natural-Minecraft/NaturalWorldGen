...
package id.naturalsmp.nwg.utilities.stream.convert;

import id.naturalsmp.nwg.utilities.collection.KList;
import id.naturalsmp.nwg.utilities.stream.ArraySignificance;
import id.naturalsmp.nwg.utilities.stream.BasicStream;
import id.naturalsmp.nwg.utilities.stream.ProceduralStream;
import id.naturalsmp.nwg.utilities.stream.Significance;
