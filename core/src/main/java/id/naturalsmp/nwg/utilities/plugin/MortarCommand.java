...
public abstract class MortarCommand implements ICommand {
    ...
    @Override
    public KList<String> handleTab(NaturalDevSender sender, String[] args) {
    ...
    public abstract void addTabOptions(NaturalDevSender sender, String[] args, KList<String> list);

    public void printHelp(NaturalDevSender sender) {
        boolean b = false;
    ...
    public void rejectAny(int past, NaturalDevSender sender, String[] a) {
        if (a.length > past) {
            int p = past;
