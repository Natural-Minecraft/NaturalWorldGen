...
package id.naturalsmp.nwg.utilities.stream;
...
import id.naturalsmp.nwg.utilities.function.Function4;
...
import id.naturalsmp.nwg.utilities.stream.arithmetic.*;
import id.naturalsmp.nwg.utilities.stream.convert.*;
import id.naturalsmp.nwg.utilities.stream.interpolation.Interpolated;
import id.naturalsmp.nwg.utilities.stream.sources.FunctionStream;
import id.naturalsmp.nwg.utilities.stream.utility.*;
