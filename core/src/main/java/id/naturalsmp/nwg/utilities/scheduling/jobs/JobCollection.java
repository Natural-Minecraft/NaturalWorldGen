...
package id.naturalsmp.nwg.utilities.scheduling.jobs;
...
public class JobCollection implements Job {
    ...
    public String getName() {
        return status == null ? name : (name + " ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¹" + status);
    }
