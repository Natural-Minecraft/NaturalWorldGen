package id.naturalsmp.nwg.utilities.misc;
...
import static id.naturalsmp.nwg.NaturalGenerator.instance;

public class SlimJar {
    private static final boolean DEBUG = Boolean.getBoolean("naturalworldgen.debug-slimjar");
    private static final boolean DISABLE_REMAPPER = Boolean.getBoolean("naturalworldgen.disable-remapper");
