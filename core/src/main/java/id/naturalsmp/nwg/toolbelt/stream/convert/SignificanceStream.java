...
package id.naturalsmp.nwg.toolbelt.stream.convert;

import id.naturalsmp.nwg.toolbelt.collection.KList;
import id.naturalsmp.nwg.toolbelt.stream.ArraySignificance;
import id.naturalsmp.nwg.toolbelt.stream.BasicStream;
import id.naturalsmp.nwg.toolbelt.stream.ProceduralStream;
import id.naturalsmp.nwg.toolbelt.stream.Significance;
