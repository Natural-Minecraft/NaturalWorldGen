...
package id.naturalsmp.nwg.toolbelt.decree.handlers;

import id.naturalsmp.nwg.toolbelt.collection.KList;
import id.naturalsmp.nwg.toolbelt.decree.DecreeContext;
import id.naturalsmp.nwg.toolbelt.decree.DecreeParameterHandler;
import id.naturalsmp.nwg.toolbelt.decree.DecreeSystem;
...
public class BlockVectorHandler implements DecreeParameterHandler<BlockVector> {
    ...
    public KList<BlockVector> getPossibilities() {
        ...
        NaturalDevSender s = DecreeContext.get();
