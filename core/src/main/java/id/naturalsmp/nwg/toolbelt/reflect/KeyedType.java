package id.naturalsmp.nwg.toolbelt.reflect;

import com.google.gson.Gson;
import com.google.gson.TypeAdapter;
import com.google.gson.reflect.TypeToken;
import id.naturalsmp.nwg.toolbelt.data.registry.RegistryTypeAdapter;
import id.naturalsmp.nwg.toolbelt.data.registry.RegistryUtil;
import org.bukkit.Keyed;

public class KeyedType {
    private static final boolean KEYED_ENABLED = Boolean.getBoolean("naturalworldgen.keyed-types");
    private static final boolean KEYED_LENIENT = Boolean.getBoolean("naturalworldgen.keyed-lenient");
