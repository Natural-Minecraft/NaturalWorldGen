...
package id.naturalsmp.nwg.toolbelt.math;

import id.naturalsmp.nwg.toolbelt.documentation.Exclusive;
import id.naturalsmp.nwg.toolbelt.documentation.Inclusive;
