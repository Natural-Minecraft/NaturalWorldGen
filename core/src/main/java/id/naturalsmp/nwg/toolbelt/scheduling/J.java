...
import id.naturalsmp.nwg.toolbelt.function.NastyFuture;
import id.naturalsmp.nwg.toolbelt.function.NastyRunnable;
import id.naturalsmp.nwg.toolbelt.function.NastySupplier;
import id.naturalsmp.nwg.toolbelt.math.FinalInteger;
...
public class J {
    ...
    public static void aBukkit(Runnable a) {
        if (!Bukkit.getPluginManager().isPluginEnabled(NaturalGenerator.instance)) {
            return;
        }
        Bukkit.getScheduler().scheduleAsyncDelayedTask(NaturalGenerator.instance, a);
    }
    ...
    public static void s(Runnable r) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(NaturalGenerator.instance, r);
    }
    ...
    public static CompletableFuture sfut(Runnable r) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(NaturalGenerator.instance, () -> {
            r.run();
            f.complete(null);
        });
        return f;
    ...
    public static int sr(Runnable r, int interval) {
        ...
        return Bukkit.getScheduler().scheduleSyncRepeatingTask(NaturalGenerator.instance, r, 0, interval);
    }
    ...
    public static void a(Runnable r, int delay) {
        if (Bukkit.getPluginManager().isPluginEnabled(NaturalGenerator.instance)) {
            Bukkit.getScheduler().scheduleAsyncDelayedTask(NaturalGenerator.instance, r, delay);
        }
    }
    ...
    public static int ar(Runnable r, int interval) {
        ...
        return Bukkit.getScheduler().scheduleAsyncRepeatingTask(NaturalGenerator.instance, r, 0, interval);
    }
