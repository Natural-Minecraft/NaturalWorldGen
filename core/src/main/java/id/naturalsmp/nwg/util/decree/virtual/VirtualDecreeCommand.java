...
package id.naturalsmp.nwg.util.decree.virtual;
...
import id.naturalsmp.nwg.util.decree.*;
...
import id.naturalsmp.nwg.util.plugin.CommandDummy;
...
public class VirtualDecreeCommand {
    ...
    public void cacheAll() {
        NaturalDevSender sender = new NaturalDevSender(new CommandDummy());
     ...
     */
    private KMap<String, Object> map(NaturalDevSender sender, KList<String> in) {
    ...
    public boolean invoke(NaturalDevSender sender, KList<String> realArgs) {
    ...
    private boolean invokeNode(NaturalDevSender sender, KMap<String, Object> map) {
        if (map == null) {
            return false;
        }
