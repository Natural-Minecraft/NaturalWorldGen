...
package id.naturalsmp.nwg.util.decree;
...
public interface DecreeSystem extends CommandExecutor, TabCompleter {
    KList<DecreeParameterHandler<?>> handlers = NaturalGenerator.initialize("id.naturalsmp.nwg.util.decree.handlers", null).convert((i) -> (DecreeParameterHandler<?>) i);
