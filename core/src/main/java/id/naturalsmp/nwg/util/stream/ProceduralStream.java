...
package id.naturalsmp.nwg.util.stream;
...
import id.naturalsmp.nwg.util.function.Function4;
...
import id.naturalsmp.nwg.util.stream.arithmetic.*;
import id.naturalsmp.nwg.util.stream.convert.*;
import id.naturalsmp.nwg.util.stream.interpolation.Interpolated;
import id.naturalsmp.nwg.util.stream.sources.FunctionStream;
import id.naturalsmp.nwg.util.stream.utility.*;
