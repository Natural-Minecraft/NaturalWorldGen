...
package id.naturalsmp.nwg.util.decree.handlers;

import id.naturalsmp.nwg.util.collection.KList;
import id.naturalsmp.nwg.util.decree.DecreeContext;
import id.naturalsmp.nwg.util.decree.DecreeParameterHandler;
import id.naturalsmp.nwg.util.decree.DecreeSystem;
