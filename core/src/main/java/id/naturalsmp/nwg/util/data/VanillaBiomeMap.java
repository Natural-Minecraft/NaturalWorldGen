...
import id.naturalsmp.nwg.util.inventorygui.RandomColor.Color;
import id.naturalsmp.nwg.util.inventorygui.RandomColor.Luminosity;
import id.naturalsmp.nwg.util.inventorygui.RandomColor.SaturationType;
