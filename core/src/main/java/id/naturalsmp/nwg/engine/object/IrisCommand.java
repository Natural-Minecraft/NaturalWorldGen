...
public class IrisCommand {
    ...
    public void run(Location at) {
        ...
        for (String command : commands) {
            ...
            if (repeat) {
                Bukkit.getScheduler().scheduleSyncRepeatingTask(NaturalGenerator.instance, () -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), finalCommand), delay, repeatDelay);
            } else {
                Bukkit.getScheduler().scheduleSyncDelayedTask(NaturalGenerator.instance, () -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), finalCommand), delay);
            }
        }
    }
}