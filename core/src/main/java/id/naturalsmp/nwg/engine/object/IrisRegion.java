...
@NoArgsConstructor
@AllArgsConstructor
@Desc("Represents an naturalworldgen region")
@Data
...
public class IrisRegion extends IrisRegistrant implements IRare {
    ...
    @Desc("Spawn Entities in this region over time. NaturalGenerator will continually replenish these mobs just like vanilla does.")
    ...
    @Desc("Objects define what schematics (iob files) naturalworldgen will place in this region")
