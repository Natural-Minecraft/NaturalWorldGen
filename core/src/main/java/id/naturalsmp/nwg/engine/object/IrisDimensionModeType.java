...
import id.naturalsmp.nwg.engine.mode.ModeEnclosure;
import id.naturalsmp.nwg.engine.mode.ModeIslands;
import id.naturalsmp.nwg.engine.mode.ModeOverworld;
import id.naturalsmp.nwg.engine.mode.ModeSuperFlat;
