...
public class IrisMod extends IrisRegistrant {
    ...
    @Desc("If this mod only works with a specific dimension, define it's load key here. Such as overworld, or flat. Otherwise naturalworldgen will assume this mod works with anything.")
