...
import id.naturalsmp.nwg.core.service.IrisEngineSVC;
import id.naturalsmp.nwg.core.tools.IrisPackBenchmarking;
...
import id.naturalsmp.nwg.toolbelt.decree.specialhandlers.NullableDimensionHandler;
import id.naturalsmp.nwg.toolbelt.format.C;
import id.naturalsmp.nwg.toolbelt.format.Form;
import id.naturalsmp.nwg.toolbelt.io.CountingDataInputStream;
import id.naturalsmp.nwg.toolbelt.io.IO;
import id.naturalsmp.nwg.toolbelt.mantle.TectonicPlate;
import id.naturalsmp.nwg.toolbelt.math.M;
import id.naturalsmp.nwg.toolbelt.matter.Matter;
import id.naturalsmp.nwg.toolbelt.nbt.mca.MCAFile;
import id.naturalsmp.nwg.toolbelt.nbt.mca.MCAUtil;
...
public class CommandDeveloper implements DecreeExecutor {
    ...
    public void fixObjects(
        ...
        IrisData dm = IrisData.get(NaturalGenerator.instance.getDataFolder("packs", type.getLoadKey()));
    ...
    public void mantle(@Param(defaultValue = "false") boolean plate, @Param(defaultValue = "21474836474") String name) throws Throwable {
        var base = NaturalGenerator.instance.getDataFile("dump", "pv." + name + ".ttp.lz4b.bin");
        var section = NaturalGenerator.instance.getDataFile("dump", "pv." + name + ".section.bin");
    ...
    public void generateStructures(
        ...
        if (dimension == null) {
            dataDir = NaturalGenerator.instance.getDataFolder("structures");
            IO.delete(dataDir);
