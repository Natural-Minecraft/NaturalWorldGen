...
import id.naturalsmp.nwg.util.nbt.tag.*;
...
public class IrisConverter {
    public static void convertSchematics(NaturalDevSender sender) {
        File folder = NaturalGenerator.instance.getDataFolder("convert");
