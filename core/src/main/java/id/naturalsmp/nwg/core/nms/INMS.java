...
import id.naturalsmp.nwg.core.nms.v1X.NMSBinding1X;
import org.bukkit.Bukkit;

import java.util.List;

public class INMS {
    private static final Version CURRENT = Boolean.getBoolean("naturalworldgen.no-version-limit") ?
    ...
    private static INMSBinding bind() {
        ...
        try {
            Class<?> clazz = Class.forName("id.naturalsmp.nwg.core.nms."+code+".NMSBinding");
            try {
