...
import id.naturalsmp.nwg.core.edit.BlockEditor;
import id.naturalsmp.nwg.core.edit.BukkitBlockEditor;
...
public class EditSVC implements IrisService {
    ...
    public void onEnable() {
        ...
        Bukkit.getScheduler().scheduleSyncRepeatingTask(NaturalGenerator.instance, this::update, 1000, 1000);
    }
