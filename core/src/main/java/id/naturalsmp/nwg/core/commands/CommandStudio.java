...
import id.naturalsmp.nwg.core.gui.NoiseExplorerGUI;
import id.naturalsmp.nwg.core.gui.VisionGUI;
import id.naturalsmp.nwg.core.loader.IrisData;
import id.naturalsmp.nwg.core.project.IrisProject;
import id.naturalsmp.nwg.core.service.ConversionSVC;
...
import id.naturalsmp.nwg.toolbelt.decree.DecreeContext;
...
import id.naturalsmp.nwg.toolbelt.function.Function2;
import id.naturalsmp.nwg.toolbelt.function.NoiseProvider;
import id.naturalsmp.nwg.toolbelt.interpolation.InterpolationMethod;
...
import id.naturalsmp.nwg.toolbelt.math.Spiraler;
import id.naturalsmp.nwg.toolbelt.noise.CNG;
import id.naturalsmp.nwg.toolbelt.parallel.MultiBurst;
import id.naturalsmp.nwg.toolbelt.parallel.SyncExecutor;
...
import id.naturalsmp.nwg.toolbelt.scheduling.jobs.ParallelRadiusJob;
...
public class CommandStudio implements DecreeExecutor {
    ...
    public void loot(
        ...
        ta.set(Bukkit.getScheduler().scheduleSyncRepeatingTask(NaturalGenerator.instance, () ->
        {
    ...
    public void profile(
        ...
        File report = NaturalGenerator.instance.getDataFile("profile.txt");
    ...
    public void objects() {
        ...
        if (!IrisToolbelt.isIrisWorld(world)) {
            sender().sendMessage("You must be in an naturalworldgen world.");
            return;
        }
