...
package id.naturalsmp.nwg.core.gui;

import id.naturalsmp.nwg.NaturalGenerator;
import id.naturalsmp.nwg.core.gui.components.IrisRenderer;
...
import static id.naturalsmp.nwg.util.data.registry.Attributes.MAX_HEALTH;
