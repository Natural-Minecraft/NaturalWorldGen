...
import id.naturalsmp.nwg.util.collection.KSet;
...
import id.naturalsmp.nwg.util.scheduling.jobs.Job;
import id.naturalsmp.nwg.util.scheduling.jobs.JobCollection;
import id.naturalsmp.nwg.util.scheduling.jobs.ParallelQueueJob;
import lombok.Data;
