...
public class IrisSettings {
    ...
    public static IrisSettings get() {
        ...
        File s = NaturalGenerator.instance.getDataFile("settings.json");
    ...
    public static class IrisSettingsAutoconfiguration {
        ...
        public boolean autoRestartOnCustomBiomeInstall = false;
    }
    ...
    public static class IrisSettingsGeneral {
        ...
        public boolean canUseCustomColors(NaturalDevSender naturalsmpSender) {
            return naturalsmpSender.isPlayer() ? useCustomColorsIngame : useConsoleCustomColors;
        }
    }
