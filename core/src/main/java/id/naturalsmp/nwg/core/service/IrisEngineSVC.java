...
import id.naturalsmp.nwg.util.stream.utility.CachedStream2D;
import id.naturalsmp.nwg.util.stream.utility.CachedStream3D;
...
public class IrisEngineSVC implements IrisService {
    ...
    public void engineStatus(NaturalDevSender sender) {
        ...
        updateTicker = new Looper() {
            ...
            protected long loop() {
                try {
                    ...
                    totalWorlds.set(naturalworldgen);
