...
import id.naturalsmp.nwg.core.link.data.DataType;
...
import id.naturalsmp.nwg.utilities.reflect.KeyedType;
...
public class SchemaBuilder {
    ...
    public JSONObject construct() {
        ...
        schema.put("$id", "https://naturalsmp.id/naturalworldgen-schema/" + root.getSimpleName().toLowerCase() + ".json");
            ...
            case "string" -> {
                ...
                if (k.isAnnotationPresent(RegistryListResource.class)) {
                    ...
                    if (loader != null) {
                        ...
                        fancyType = "NaturalGenerator " + loader.getResourceTypeName();
    ...
    private String getType(Class<?> c) {
        ...
        if (!c.isAnnotationPresent(Desc.class) && c.getCanonicalName().startsWith("id.naturalsmp.nwg.")) {
    ...
    private String getDescription(Class<?> r) {
        ...
        if (!r.isPrimitive() && !r.equals(KList.class) && !r.equals(KMap.class) && r.getCanonicalName().startsWith("com.naturalsmp.")) {
