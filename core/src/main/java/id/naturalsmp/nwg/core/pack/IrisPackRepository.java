...
import id.naturalsmp.nwg.util.scheduling.jobs.DownloadJob;
import id.naturalsmp.nwg.util.scheduling.jobs.JobCollection;
import id.naturalsmp.nwg.util.scheduling.jobs.SingleJob;
...
public class IrisPackRepository {
    ...
    public void install(NaturalDevSender sender, Runnable whenComplete) throws MalformedURLException {
