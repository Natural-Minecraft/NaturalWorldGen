...
package id.naturalsmp.nwg.core.link;
...
// See/update https://app.gitbook.com/@naturalsmpsoftware/s/naturalworldgen/compatability/papi/
public class IrisPapiExpansion extends PlaceholderExpansion {
    ...
    public @NotNull String getAuthor() {
        return "NaturalDev Software";
    }

    @Override
    public @NotNull String getVersion() {
        return NaturalGenerator.instance.getDescription().getVersion();
    }
