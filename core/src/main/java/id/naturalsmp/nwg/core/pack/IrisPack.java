...
package id.naturalsmp.nwg.core.pack;
...
/**
 * Represents an NaturalGenerator pack that exists
 */
@Data
public class IrisPack {
    ...
    /**
     * Create an naturalworldgen pack backed by a data folder
     * the data folder is assumed to be in the NaturalGenerator/packs/NAME folder
     *
     * @param name the name
     */
     ...
     * @return the naturalworldgen pack
     * @throws IrisException fails
     */
    public static Future<IrisPack> from(NaturalDevSender sender, String url) throws IrisException {
     ...
     */
    public static Future<IrisPack> from(NaturalDevSender sender, IrisPackRepository repo) throws MalformedURLException {
    ...
    /**
     * Get a packs pack folder for a name. Such that overworld would resolve as NaturalGenerator/packs/overworld
     *
     * @param name the name
     * @return the file path
     */
    public static File packsPack(String name) {
        return NaturalGenerator.instance.getDataFolderNoCreate(StudioSVC.WORKSPACE_NAME, name);
    }
     ...
     *
     * @param world the world to install into (world/naturalworldgen/pack)
     * @return the installed pack
     */
    public IrisPack install(World world) throws IrisException {
        return install(new File(world.getWorldFolder(), "naturalworldgen/pack"));
    }
    ...
    public IrisPack install(IrisWorld world) throws IrisException {
        return install(new File(world.worldFolder(), "naturalworldgen/pack"));
    }
