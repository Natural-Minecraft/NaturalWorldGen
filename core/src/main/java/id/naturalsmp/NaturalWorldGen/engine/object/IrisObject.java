...
import id.naturalsmp.NaturalWorldGen.engine.framework.PlacedObject;
import id.naturalsmp.NaturalWorldGen.engine.framework.placer.HeightmapObjectPlacer;
...
import id.naturalsmp.NaturalWorldGen.util.data.VectorMap;
import id.naturalsmp.NaturalWorldGen.util.format.Form;
import id.naturalsmp.NaturalWorldGen.util.interpolation.IrisInterpolation;
import id.naturalsmp.NaturalWorldGen.util.json.JSONObject;
import id.naturalsmp.NaturalWorldGen.util.math.*;
import id.naturalsmp.NaturalWorldGen.util.matter.MatterMarker;
...
import id.naturalsmp.NaturalWorldGen.util.stream.ProceduralStream;
...
public class IrisObject extends IrisRegistrant {
    ...
    public void write(OutputStream o, NaturalDevSender sender) throws IOException {
    ...
    public void write(File file, NaturalDevSender sender) throws IOException {
        if (file == null) {
            return;
        }
