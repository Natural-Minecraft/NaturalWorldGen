...
import id.naturalsmp.NaturalWorldGen.engine.framework.EngineAssignedWorldManager;
...
import id.naturalsmp.NaturalWorldGen.util.scheduling.jobs.QueueJob;
...
public class IrisWorldManager extends EngineAssignedWorldManager {
    ...
    private void warmupAreaAsync(Player player, Location to, Runnable r) {
        J.a(() -> {
            ...
            }.queue(futures).execute(new NaturalDevSender(player), true, r);
        });
    }
