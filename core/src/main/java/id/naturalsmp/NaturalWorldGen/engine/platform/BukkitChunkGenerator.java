...
import id.naturalsmp.NaturalWorldGen.engine.IrisEngine;
import id.naturalsmp.NaturalWorldGen.engine.data.cache.AtomicCache;
import id.naturalsmp.NaturalWorldGen.engine.data.chunk.TerrainChunk;
...
import id.naturalsmp.NaturalWorldGen.engine.object.StudioMode;
import id.naturalsmp.NaturalWorldGen.engine.platform.studio.StudioGenerator;
import id.naturalsmp.NaturalWorldGen.util.collection.KList;
import id.naturalsmp.NaturalWorldGen.util.data.IrisBiomeStorage;
import id.naturalsmp.NaturalWorldGen.util.hunk.view.BiomeGridHunkHolder;
import id.naturalsmp.NaturalWorldGen.util.hunk.view.ChunkDataHunkHolder;
import id.naturalsmp.NaturalWorldGen.util.io.ReactiveFolder;
...
public class BukkitChunkGenerator extends ChunkGenerator implements PlatformChunkGenerator, Listener {
    ...
    public BukkitChunkGenerator(IrisWorld world, boolean studio, File dataLocation, String dimensionKey) {
        ...
        Bukkit.getServer().getPluginManager().registerEvents(this, NaturalGenerator.instance);
    }

    @EventHandler(priority = EventPriority.LOWEST)
    public void onWorldInit(WorldInitEvent event) {
        if (!world.name().equals(event.getWorld().getName())) return;
        NaturalGenerator.instance.unregisterListener(this);
