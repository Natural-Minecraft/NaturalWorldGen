...
import id.naturalsmp.NaturalWorldGen.core.link.IrisPapiExpansion;
import id.naturalsmp.NaturalWorldGen.core.link.MultiverseCoreLink;
...
import id.naturalsmp.NaturalWorldGen.engine.object.IrisCompat;
...
import id.naturalsmp.NaturalWorldGen.engine.platform.BukkitChunkGenerator;
...
import id.naturalsmp.NaturalWorldGen.util.io.FileWatcher;
import id.naturalsmp.NaturalWorldGen.util.io.IO;
import id.naturalsmp.NaturalWorldGen.util.io.InstanceState;
...
import id.naturalsmp.NaturalWorldGen.util.misc.Bindings;
import id.naturalsmp.NaturalWorldGen.util.misc.SlimJar;
...
import id.naturalsmp.NaturalWorldGen.util.plugin.NaturalDevPlugin;
import id.naturalsmp.NaturalWorldGen.util.plugin.NaturalDevSender;
import id.naturalsmp.NaturalWorldGen.util.plugin.chunk.ChunkTickets;
import id.naturalsmp.NaturalWorldGen.util.scheduling.J;
import id.naturalsmp.NaturalWorldGen.util.scheduling.Queue;
import id.naturalsmp.NaturalWorldGen.util.scheduling.ShurikenQueue;
...
public class NaturalGenerator extends NaturalDevPlugin implements Listener {
    ...
    private void enable() {
        ...
        initialize("id.naturalsmp.NaturalWorldGen.core.service").forEach((i) -> services.put((Class<? extends IrisService>) i.getClass(), (IrisService) i));
