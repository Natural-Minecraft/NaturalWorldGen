...
import id.naturalsmp.NaturalWorldGen.util.inventorygui.RandomColor.Color;
import id.naturalsmp.NaturalWorldGen.util.inventorygui.RandomColor.Luminosity;
import id.naturalsmp.NaturalWorldGen.util.inventorygui.RandomColor.SaturationType;
