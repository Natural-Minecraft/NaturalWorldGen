package id.naturalsmp.NaturalWorldGen.util.cache;
...
public class ChunkCache2D<T> {
    private static final boolean FAST = Boolean.getBoolean("naturalworldgen.cache.fast");
    private static final boolean DYNAMIC = Boolean.getBoolean("naturalworldgen.cache.dynamic");
