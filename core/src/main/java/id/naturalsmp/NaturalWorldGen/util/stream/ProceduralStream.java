...
import id.naturalsmp.NaturalWorldGen.engine.object.IrisStyledRange;
...
import id.naturalsmp.NaturalWorldGen.util.function.Function3;
import id.naturalsmp.NaturalWorldGen.util.function.Function4;
...
import id.naturalsmp.NaturalWorldGen.util.stream.arithmetic.*;
import id.naturalsmp.NaturalWorldGen.util.stream.convert.*;
import id.naturalsmp.NaturalWorldGen.util.stream.interpolation.Interpolated;
import id.naturalsmp.NaturalWorldGen.util.stream.sources.FunctionStream;
import id.naturalsmp.NaturalWorldGen.util.stream.utility.*;
