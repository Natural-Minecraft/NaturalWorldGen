...
import id.naturalsmp.NaturalWorldGen.util.function.NoiseInjector;
...
import id.naturalsmp.NaturalWorldGen.util.stream.arithmetic.FittedStream;
import id.naturalsmp.NaturalWorldGen.util.stream.sources.CNGStream;
import lombok.Data;
