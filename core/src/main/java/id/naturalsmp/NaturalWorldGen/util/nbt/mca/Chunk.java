...
import id.naturalsmp.NaturalWorldGen.util.nbt.io.NBTDeserializer;
import id.naturalsmp.NaturalWorldGen.util.nbt.io.NBTSerializer;
import id.naturalsmp.NaturalWorldGen.util.nbt.io.NamedTag;
import id.naturalsmp.NaturalWorldGen.util.nbt.mca.palette.MCABiomeContainer;
...
import static id.naturalsmp.NaturalWorldGen.util.nbt.mca.LoadFlags.*;
