...
package id.naturalsmp.NaturalWorldGen.util.decree.context;

import id.naturalsmp.NaturalWorldGen.core.tools.IrisToolbelt;
import id.naturalsmp.NaturalWorldGen.engine.framework.Engine;
import id.naturalsmp.NaturalWorldGen.engine.object.IrisGenerator;
import id.naturalsmp.NaturalWorldGen.util.decree.DecreeContextHandler;
...
public class GeneratorContextHandler implements DecreeContextHandler<IrisGenerator> {
    ...
    @Override
    public IrisGenerator handle(NaturalDevSender sender) {
        if (sender.isPlayer()
