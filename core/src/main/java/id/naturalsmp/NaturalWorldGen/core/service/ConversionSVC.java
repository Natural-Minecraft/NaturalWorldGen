...
import id.naturalsmp.NaturalWorldGen.util.function.Consumer2;
import id.naturalsmp.NaturalWorldGen.util.io.Converter;
import id.naturalsmp.NaturalWorldGen.util.io.IO;
import id.naturalsmp.NaturalWorldGen.util.json.JSONObject;
import id.naturalsmp.NaturalWorldGen.util.nbt.io.NBTUtil;
import id.naturalsmp.NaturalWorldGen.util.nbt.io.NamedTag;
import id.naturalsmp.NaturalWorldGen.util.nbt.mca.NBTWorld;
import id.naturalsmp.NaturalWorldGen.util.nbt.tag.CompoundTag;
import id.naturalsmp.NaturalWorldGen.util.nbt.tag.IntTag;
import id.naturalsmp.NaturalWorldGen.util.nbt.tag.ListTag;
...
public class ConversionSVC implements IrisService {
    ...
    public void onEnable() {
        folder = NaturalGenerator.instance.getDataFolder("convert");
    ...
    public void convertStructures(File in, File out, NaturalDevSender s) {
    ...
    public void check(NaturalDevSender s) {
        int m = 0;
        NaturalGenerator.instance.getDataFolder("convert");
