...
import id.naturalsmp.NaturalWorldGen.util.reflect.KeyedType;
...
public class SchemaBuilder {
    ...
    private String getType(Class<?> c) {
        ...
        if (!c.isAnnotationPresent(Desc.class) && c.getCanonicalName().startsWith("id.naturalsmp.NaturalWorldGen.")) {
