...
import id.naturalsmp.NaturalWorldGen.core.edit.JigsawEditor;
...
import id.naturalsmp.NaturalWorldGen.engine.jigsaw.PlannedStructure;
...
@Decree(name = "jigsaw", origin = DecreeOrigin.PLAYER, studio = true, description = "NaturalWorldGen jigsaw commands")
