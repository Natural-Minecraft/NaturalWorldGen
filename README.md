...
Building NaturalWorldGen is fairly simple, though you will need to setup a few things if your system has never been used for java
development.

Consider supporting our development by buying NaturalWorldGen on spigot! We work hard to make NaturalWorldGen the best it can be for everyone.
...
* Add a build line in the build.gradle for your own build task to directly compile NaturalWorldGen into your plugins folder if you
  prefer.
* Resync the project & run your newly created task (under the development folder in gradle tasks!)

# NaturalWorldGen Toolbelt
